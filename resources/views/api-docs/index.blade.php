        ...
        <div class="p-4 flex-1 overflow-y-auto">
            ...
            <div x-show="menuState === 'default'" x-transition:enter.duration.500ms x-transition:leave.duration.300ms>
                ...
                <div class="space-y-1 mt-2">
                    <button @click="menuState = 'content-tools'" class="w-full flex items-center justify-between p-2 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-md transition duration-150">
                        <span class="flex items-center space-x-2">
    ...
    <div class="flex flex-col space-y-4 mb-8">
        ...
        <div class="flex justify-start">
            ...
            <div class="ml-6 pt-2">
                ...
                <p class="text-xs text-gray-500 mt-1 text-left">Max size: 2MB | Supported formats: PNG, SVG</p>
                <div class="mt-2 text-xs">
                    <a href="#" class="text-gray-600 font-medium underline">Don’t have a logo? use name instead</a>
                    <span class="mx-1"></span>
                    <a href="#" class="text-gray-600 font-medium underline">Set custom redirection link</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="border-b border-gray-300 pb-6">
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button class="flex items-center space-x-1 px-3 py-1 text-xs text-gray-700 bg-gray-100 rounded-full hover:bg-gray-200 transition duration-150">
            ...
            <div>
                ...
                <div class="flex space-x-3 mt-4">
                    <button class="px-6 py-1.5 text-xs font-semibold text-purple-500 bg-white underline">Link</button>
                    <button class="px-6 py-1.5 text-xs font-semibold text-purple-700 bg-white underline">Link</button>
                    <button class="px-6 py-1.5 text-xs font-semibold text-pink-800 bg-white underline">Link</button>
                    <button class="px-6 py-1.5 text-xs font-semibold text-purple-500 bg-gray-800 rounded-lg">Link</button>
                    <button class="px-6 py-1.5 text-xs font-semibold text-purple-700 bg-gray-800 rounded-lg">Link</button>
                    <button class="px-6 py-1.5 text-xs font-semibold text-pink-800 bg-gray-800 rounded-lg">Link</button>
                </div>
            </div>
        </div>
    ...
    <div class="flex space-x-8 overflow-x-auto pb-4">
        ...
        <div class="flex flex-col items-center">
            <div class="min-w-[125px] h-70 border border-gray-300 p-3 rounded-lg bg-white hover:border-purple-500 cursor-pointer">
                <p class="text-sm font-semibold mb-2" style="font-family: 'Quicksand', sans-serif;">Why did we build Document360?</p>
                <p class="text-xs text-gray-600" style="font-family: 'Quicksand', sans-serif;">Exploring a new product... (Preview text)</p>
            </div>
        ...
        <div class="flex flex-col items-center">
            <div class="min-w-[125px] h-70 border border-gray-300 p-3 rounded-lg bg-white hover:border-purple-500 cursor-pointer">
                <p class="text-sm font-semibold mb-2" style="font-family: 'Ubuntu', sans-serif;">Why did we build Document360?</p>
                <p class="text-xs text-gray-600" style="font-family: 'Open Sans', sans-serif;">Exploring a new product... (Preview text)</p>
            </div>
