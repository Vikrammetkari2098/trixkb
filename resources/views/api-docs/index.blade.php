            ...
            <div class="p-4 flex-1 overflow-y-auto">
                ...
                <div x-show="menuState === 'default'" x-transition:enter.duration.500ms x-transition:leave.duration.300ms>
                    ...
                    <div class="space-y-1 mt-2">
                        <button @click="menuState = 'content-tools'"
                            class="w-full flex items-center justify-between p-2 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-md transition duration-150">
                            <span class="flex items-center space-x-2">
        ...
        <main class="flex-1 flex flex-col items-center justify-center text-center overflow-y-auto w-full h-full">
            ...
            <div x-show="menuState === 'default'" class="w-full h-full flex flex-col items-center justify-center p-8">
                ...
                <div class="mb-6 w-80 h-auto mx-auto">
                    <img src="{{ asset('image/apiimage.png') }}" alt="API Documentation Illustration"
                ...
                <button
                    class="mt-6 px-8 py-3 text-sm font-medium text-white bg-purple-600 rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-4 focus:ring-purple-300 transition duration-150 ease-in-out uppercase tracking-wider">
                    new API
                </button>
            </div>
            <!-- Custom Pages -->
            <div x-show="menuState === 'content-tools' && contentToolState === 'custom-pages'"
                ...
                <div class="mb-6 w-80 h-auto mx-auto">
                    <img src="{{ asset('image/apiimage2.png') }}" alt="API Documentation Illustration"
                        class="mx-auto max-w-full h-auto">
                </div>

                <h2 class="text-xl md:text-2xl font-semibold text-gray-800">
                    No custom page available
                </h2>

                <p class="mt-2 text-base text-gray-500">
                    You don't have any custom pages yet. Create pages like Terms and Conditions or Privacy Policy.
                    <br>
                    You can link these pages to your knowledge base site during customization.
                </p>
            ...
            <div x-show="menuState === 'content-tools' && contentToolState === 'find-and-replace'"
                ...
                <div class="w-full flex justify-between items-start mb-6 pt-4">
                    <div class="text-left">
                        <h2 class="text-xl md:text-2xl font-semibold text-gray-800 flex items-center mb-1 mr-2">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6 text-blue-500 mr-2">
                    ...
                    <button
                        class="flex items-center space-x-1 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition duration-150">
                ...
                <div class="w-full mb-10">
                    <div class="flex flex-wrap items-center gap-4">
                        ...
                        <div class="flex items-center space-x-2 w-100">
                            <label for="find-text"
                                class="text-sm font-medium text-gray-700 whitespace-nowrap">Find</label>
                        ...
                        <div class="flex items-center space-x-2 w-110">
                            <label for="replace-text" class="text-sm font-medium text-gray-700 whitespace-nowrap">Replace
                                with</label>
                        ...
                        <button
                            class="px-6 py-2.5 text-sm font-medium text-white bg-purple-600 rounded-md shadow-md hover:bg-purple-700 transition duration-150 h-10">
                            Replace
                        </button>
                    </div>
                ...
                <div class="w-full max-w-4xl flex flex-col items-center justify-center pt-8">
                    ...
                    <div class="mb-6 w-80 h-auto mx-auto">
                        <img src="{{ asset('image/apiimage3.png') }}" alt="Find and Replace Illustration"
                            class="mx-auto max-w-full h-auto">
                    </div>
            ...
            <div x-show="menuState === 'site-builder' && siteBuilderState === 'customize-site'"
                ...
                <div class="w-full mx-auto px-4 sm:px-6 lg:px-8  p-6 rounded-l mb-4 flex justify-between items-center">
                       <h2 class="text-2xl font-semibold text-gray-800 text-left ml-0">Customize site</h2>                    
                    <div class="space-x-2">
                        <button
                    ...
                    <div class="flex items-start space-x-4 pt-0">
                        ...
                        <div class="flex flex-col">
                            ...
                            <p class="text-sm text-gray-600 mb-4 max-w-4xl text-left">Personalize your website by
                                incorporating branding elements, header and footer sections, homepage, login page, and error
                                pages all in one central location.</p>
                    ...
                    <div class="border-b border-gray-300 pb-6">
                        ...
                        <div class="flex items-center space-x-6">
                            <label class="flex items-center space-x-2 cursor-pointer">
                                <input type="radio" name="site-theme"
                    ...
                    <div class="border-b border-gray-300 pb-6">
                        ...
                        <div class="flex flex-col space-y-4 mb-8">
                            ...
                            <div class="flex justify-start">
                                ...
                                <div class="flex space-x-4">
                                    ...
                                    <div
                                        class="w-35 h-35 border border-gray-300 rounded-lg flex flex-col items-center justify-end p-2 cursor-pointer bg-white shadow-md">
                                        <img src="{{ asset('image/kblogo.png') }}" alt="Light Theme Logo"
                                            class="w-full h-auto object-contain mb-3">
                                        <div class="text-xs text-gray-400">Click to change</div>
                                    </div>

                                    <div
                                        class="w-35 h-35 border border-gray-300 rounded-lg flex flex-col items-center justify-end p-2 cursor-pointer bg-black shadow-md">
                                        <img src="{{ asset('image/kblogo.png') }}" alt="Dark Theme Logo"
                                            class="w-full h-auto object-contain mb-3" style="filter: invert(1);">
                                        <div class="text-xs text-gray-400 text-white">Click to change</div>
                                    </div>
                                </div>

                                <div class="ml-6 pt-2">
                                    <p class="text-sm font-medium text-gray-700 text-left">Logo</p>
                                    <p class="text-xs text-gray-500 mt-1 text-left">Max size: 2MB | Supported formats: PNG,
                                        SVG</p>
                                    <div class="mt-2 text-xs">
                                        <a href="#" class="text-gray-600 font-medium underline">Don’t have a logo?
                                            use name instead</a>
                                        <span class="mx-1"></span>
                                        <a href="#" class="text-gray-600 font-medium underline">Set custom
                                            redirection link</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="flex flex-col space-y-4 pt-4">
                            ...
                            <div class="flex justify-start items-start">
                                ...
                                <div
                                    class="w-70 h-35 border border-gray-300 rounded-lg flex flex-col items-center justify-center p-2 cursor-pointer bg-white shadow-md">
                                    <img src="{{ asset('image/kbai.png') }}" alt="Favicon"
                                        class="w-8 h-8 object-contain mb-3">
                                    <button class="text-xs text-gray-400">Click to change</button>
                                </div>

                                <div class="ml-8 pt-2">
                                    <p class="text-sm font-medium text-gray-700 text-left">Favicon <i
                                            class="fa-solid fa-info-circle text-gray-400 text-xs ml-1"></i></p>
                                    <p class="text-xs text-gray-500 mt-1 max-w-xl text-left">
                                        Max size: 200KB | Supported formats: ICO, PNG, SVG | Recommended resolutions: 16×16,
                                        32×32, 48×48, 64×64, 128×128, 180×180, and 256×256 pixels.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="border-b border-gray-300 pb-6">
                        ...
                        <p class="text-xs text-gray-500 mb-4 text-left">This will be applied at your article Titles and
                            Contents.</p>
                        ...
                        <div class="flex space-x-8 overflow-x-auto pb-4">
                            ...
                            <div class="flex flex-col items-center">
                                <div
                                    class="min-w-[125px] h-70 border-2 border-purple-600 p-3 rounded-lg bg-purple-50 cursor-pointer">
                                    <p class="text-sm font-semibold mb-2"
                                        style="font-family: 'Thillium Web', sans-serif;">Why did we build Document360?</p>
                                    <p class="text-xs text-gray-600" style="font-family: 'Inter', sans-serif;">Exploring a
                                        new product... (Preview text)</p>
                                </div>
                            ...
                            <div class="flex flex-col items-center">
                                <div
                                    class="min-w-[125px] h-70 border border-gray-300 p-3 rounded-lg bg-white hover:border-purple-500 cursor-pointer">
                                    <p class="text-sm font-semibold mb-2" style="font-family: 'Quicksand', sans-serif;">
                                        Why did we build Document360?</p>
                                    <p class="text-xs text-gray-600" style="font-family: 'Quicksand', sans-serif;">
                                        Exploring a new product... (Preview text)</p>
                                </div>
                                <p class="mt-2 text-xs font-semibold text-gray-700 text-center">Quicksand + Quicksand</p>
                            </div>

                            <div class="flex flex-col items-center">
                                <div
                                    class="min-w-[125px] h-70 border border-gray-300 p-3 rounded-lg bg-white hover:border-purple-500 cursor-pointer">
                                    <p class="text-sm font-semibold mb-2" style="font-family: 'Ubuntu', sans-serif;">Why
                                        did we build Document360?</p>
                                    <p class="text-xs text-gray-600" style="font-family: 'Open Sans', sans-serif;">
                                        Exploring a new product... (Preview text)</p>
                                </div>
                                <p class="mt-2 text-xs font-semibold text-gray-700 text-center">Ubuntu + Open Sans</p>
                            </div>

                            <div class="flex flex-col items-center">
                                <div
                                    class="min-w-[125px] h-70 border border-gray-300 p-3 rounded-lg bg-white hover:border-purple-500 cursor-pointer">
                                    <p class="text-sm font-semibold mb-2" style="font-family: 'Roboto', sans-serif;">Why
                                        did we build Document360?</p>
                                    <p class="text-xs text-gray-600" style="font-family: 'Nunito', sans-serif;">Exploring
                                        a new product... (Preview text)</p>
                                </div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-col gap-6">
                            ...
                            <div class="flex items-center space-x-6">
                                <div class="w-80 h-40">
                                    <div
                                        class="p-4 border-1 border-gray-400  rounded-lg bg-white cursor-pointer w-full h-full">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-600 mt-1 max-w-lg text-left">
                                        Your KB site will be restricted to certain width on every screen your
                                        customers/users are viewing.
                                    </p>
                                </div>
                            </div>
                        </div>
