...
@section('content')
    <div class="bg-white">
            ...
            @endphp
        <div class="p-6 bg-white min-h-screen shadow-md border border-gray-200 space-y-6">
                    ...
                    <div class="flex justify-end mt-6 mb-10 gap-3">
                        <div class="relative">
                            <input type="text" placeholder="Search"
                                class="px-4 py-2 border border-gray-300 rounded-md w-64 pl-10 bg-gray-100 focus:bg-white focus:outline-none">
                        ...
                        <button class="p-2 border border-gray-300 rounded-md hover:bg-gray-50 flex items-center justify-center">
                ...
                <div x-data="{ qaTab: 'unanswered' }">
                    ...
                    <div class="flex justify-end mt-6 mb-10 gap-3">
                        <div class="relative">
                            ...
                            <svg class="w-4 h-4 absolute left-3 top-3 opacity-60" fill="none" stroke="currentColor"
