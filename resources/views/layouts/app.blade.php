                ...
                <ul class="menu p-2 gap-2 text-base-content w-full">
                    ...
                    <li class="relative group">
                        <a href="{{ route('dashboard') }}" 
                           ...
                           :class="(activePath === '/' || activePath.includes('/dashboard')) ? 'bg-[#09325d] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'">
                        ...
                        {{-- Tooltip --}}
                        <div x-show="!sidebarOpen" class="fixed left-20 ml-2 px-2 py-1 bg-[#09325d] text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-[999]">Dashboard</div>
                    </li>
                    ...
                    <li class="relative group">
                        <a href="{{ route('docs') }}" 
                           class="flex items-center gap-4 px-3 py-3 rounded-xl transition-all duration-200"
                           :class="activePath.includes('/docs') ? 'bg-[#09325d] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'">
                        ...
                        <div x-show="!sidebarOpen" class="fixed left-20 ml-2 px-2 py-1 bg-[#09325d] text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-[999]">Documentation</div>
                    </li>
                    ...
                    <li class="relative group">
                        <a href="{{ route('decision.tree') }}" 
                           class="flex items-center gap-4 px-3 py-3 rounded-xl transition-all duration-200"
                           :class="activePath.includes('/decision-tree') ? 'bg-[#09325d] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'">
                            <div class="w-6 h-6 flex justify-center items-center shrink-0">
                        ...
                        <div x-show="!sidebarOpen" class="fixed left-20 ml-2 px-2 py-1 bg-[#09325d] text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-[999]">Interactive Decision Tree</div>
                    </li>
                    ...
                    <li class="relative group">
                        <a href="{{ route('api.docs') }}" 
                           class="flex items-center gap-4 px-3 py-3 rounded-xl transition-all duration-200"
                           :class="activePath.includes('/api-docs') ? 'bg-[#09325d] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'">
                            <div class="w-6 h-6 flex justify-center items-center shrink-0">
                        ...
                        <div x-show="!sidebarOpen" class="fixed left-20 ml-2 px-2 py-1 bg-[#09325d] text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-[999]">API Documentation</div>
                    </li>
                    ...
                    <li class="relative group">
                        <a href="{{ route('feedback.index') }}" 
                           class="flex items-center gap-4 px-3 py-3 rounded-xl transition-all duration-200"
                           :class="activePath.includes('/feedback') ? 'bg-[#09325d] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'">
                        ...
                        <div x-show="!sidebarOpen" class="fixed left-20 ml-2 px-2 py-1 bg-[#09325d] text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-[999]">Feedback Manager</div>
                    </li>
                    ...
                    <li class="relative group">
                        <a href="{{ route('analytics') }}" 
                           class="flex items-center gap-4 px-3 py-3 rounded-xl transition-all duration-200"
                           :class="activePath.includes('/analytics') ? 'bg-[#09325d] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'">
                            <div class="w-6 h-6 flex justify-center items-center shrink-0">
                        ...
                        <div x-show="!sidebarOpen" class="fixed left-20 ml-2 px-2 py-1 bg-[#09325d] text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-[999]">Analytics</div>
                    </li>
                    ...
                    <li class="relative group">
                        <a href="{{ route('knowledge.pulse') }}" 
                           class="flex items-center gap-4 px-3 py-3 rounded-xl transition-all duration-200"
                           :class="activePath.includes('/knowledge-pulse') ? 'bg-[#09325d] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'">
                            <div class="w-6 h-6 flex justify-center items-center shrink-0">
                        ...
                        <div x-show="!sidebarOpen" class="fixed left-20 ml-2 px-2 py-1 bg-[#09325d] text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-[999]">Knowledge Pulse</div>
                    </li>
                    ...
                    <li class="relative group">
                        <a href="{{ route('widget') }}" 
                           class="flex items-center gap-4 px-3 py-3 rounded-xl transition-all duration-200"
                           :class="activePath.includes('/widget') ? 'bg-[#09325d] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'">
                            <div class="w-6 h-6 flex justify-center items-center shrink-0">
                        ...
                        <div x-show="!sidebarOpen" class="fixed left-20 ml-2 px-2 py-1 bg-[#09325d] text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-[999]">Widget</div>
                    </li>
                    ...
                    <li class="relative group">
                        <a href="{{ route('drive') }}" 
                           class="flex items-center gap-4 px-3 py-3 rounded-xl transition-all duration-200"
                           :class="activePath.includes('/drive') ? 'bg-[#09325d] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'">
                            <div class="w-6 h-6 flex justify-center items-center shrink-0">
                        ...
                        <div x-show="!sidebarOpen" class="fixed left-20 ml-2 px-2 py-1 bg-[#09325d] text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-[999]">Drive</div>
                    </li>
                    ...
                    <li class="relative group">
                        <a href="{{ route('settings') }}" 
                           ...
                           :class="activePath.includes('/settings') ? 'bg-[#09325d] text-white shadow-md' : 'text-gray-600 hover:bg-gray-100'">
                            <div class="w-6 h-6 flex justify-center items-center shrink-0">
                                <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6 stroke-current stroke-2">
                        ...
                        <div x-show="!sidebarOpen" class="fixed left-20 ml-2 px-2 py-1 bg-[#09325d] text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-[999]">Settings</div>
                    </li>
