...
<head>
    ...
    <style>
        ...
        .text-smooth { transition: all 0.3s ease-in-out; }
    </style>
</head>
...
<body id="page-top" class="bg-white text-base-content font-sans antialiased overflow-hidden">
    ...
    <div x-data="{
         ...
         x-init="document.addEventListener('livewire:navigated', () => { activePath = window.location.pathname; });"
        ...
        <div class="flex flex-1 pt-16 h-full overflow-hidden">
            ...
            >
                ...
                <div class="p-3 flex justify-start sticky top-0 bg-white z-10">
                    <button @click="toggleSidebar()" class="text-[#000000]">
                        <svg viewBox="0 0 24 24" fill="none" class="w-6 h-6 transition-transform duration-300" :class="sidebarOpen ? 'rotate-180' : 'rotate-0'">
                            <g stroke-width="0"></g><g stroke-linecap="round" stroke-linejoin="round"></g><g> <path d="M6 17L11 12L6 7M13 17L18 12L13 7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g>
                        </svg>
                    </button>
                </div>
                       ...
                       <a href="{{ route('dashboard') }}"
                         class="flex items-center justify-between px-3 py-3 rounded-xl cursor-pointer transition-colors duration-200 relative"
                            ...
                            <div class="flex items-center gap-4 overflow-hidden">
                                ...
                                <span x-show="sidebarOpen" x-transition class="text-smooth whitespace-nowrap font-medium">Dashboard</span>
                            </div>
                         </a>
                        ...
                        <div x-show="hover"
                            ...
                            <ul class="space-y-1">
                                <li>
                                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-md transition">
                                        <i class="fas fa-home text-xs w-4 text-center"></i> Home
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-md transition">
                                        <i class="fas fa-chart-pie text-xs w-4 text-center"></i> Overview
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-md transition">
                                        <i class="fas fa-tasks text-xs w-4 text-center"></i> Tasks
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-md transition">
                                        <i class="fas fa-history text-xs w-4 text-center"></i> Recent
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-md transition">
                                        <i class="fas fa-star text-xs w-4 text-center"></i> Starred
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-md transition">
                                        <i class="fas fa-trash text-xs w-4 text-center"></i> Recycle Bin
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div x-show="hover"
                             ...
                             <ul class="space-y-1">
                                <li><a href="{{ route('feedback.index') }}" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-md transition"><svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <polyline points="7.25 14.25,2.75 14.25,2.75 1.75,13.25 1.75,13.25 9.25"></polyline> <path d="m9.75 12.75 1.5 1.5 3-2.5m-8.5-4h4.5m-4.5 3h1.5m-1.5-6h4.5"></path> </g></svg>
                                     Articles</a></li>
                                <li><a href="{{ route('feedback.index', ['viewMode' => 'eddy-ai']) }}" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 hover:bg-gray-100 rounded-md transition"><img src="{{ asset('image/icon.png') }}" class="w-4 h-4"> Eddy AI</a></li>
                             </ul>
                        </div>
                    </li>
            ...
            {{-- Main Content --}}
            <main class="flex-1 bg-gray-50 p-6 overflow-y-auto min-h-screen">
                <x-dialog />
                <x-toast />
                @yield('content')
            </main>
