    ...
    <div  class="bg-white rounded-xl shadow-soft p-5 md:p-6 mb-6">
        ...
        >
            ...
            <div x-show="showCreateModal"
                ...
                <div x-show="showCreateModal"
                    x-transition.scale
                    class="bg-white rounded-lg shadow-lg w-full max-w-5xl h-[90vh] flex flex-col overflow-hidden border border-gray-200">

                    <!-- Header -->
                    <header class="flex items-center justify-between p-4 border-b border-gray-200">
                        <h2 class="text-xl font-semibold text-gray-700">Create New Article</h2>
                    ...
                    <!-- Body -->
                    <main class="flex-grow overflow-y-auto p-6 bg-white">
                    ...
                    <!-- Footer -->
                    <footer class="flex items-center justify-end p-4 border-t border-gray-200 bg-gray-50">
                        <button @click="showCreateModal = false"
                            class="px-4 py-2 mr-3 rounded-lg text-gray-700 hover:bg-gray-100">
                            Cancel
                        </button>
