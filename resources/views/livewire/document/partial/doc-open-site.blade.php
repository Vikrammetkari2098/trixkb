<div class="p-6 space-y-4">
    <div class="font-sans text-dark-gray" x-data="{ mobileMenuOpen: false, openSidePage: false }">
        <header class="shadow-sm bg-white" x-data="{ mobileMenuOpen: false }">
        ...
        <section class="text-center py-16 sm:py-24" style="background-image: linear-gradient(135deg, #A74E91 0%, #6A329D 100%);">
            <div class="mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-8">
                    <a href="#" class="inline-flex items-center justify-center px-6 py-3 border border-white text-base font-medium rounded-md text-white bg-purple hover:bg-secondary transition">
                        Documentation
                    </a>
                </div>
        ...
        <section class="bg-black relative py-16 overflow-hidden" style="background-image: linear-gradient(158deg, #4a058bff 25%, #b56df8ff 35%, #6a1eb1ff 30%);"></div>
