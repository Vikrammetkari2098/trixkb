                 ...
                 <div wire:key="article-{{ $version->id }}" class="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="hidden sm:block flex-shrink-0">
                           <img
                                src="{{ asset('storage/assets/article_image/' . basename($version->article->article_image)) }}"
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-600 mb-4 leading-relaxed">
                                {{ Str::limit(strip_tags(editorjs_text($version->content ?? null)), 160) }}
                            </p>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                <div class="flex items-center gap-6">
                                    <span class="text-sm text-gray-500">
                                        ...
                                        {{ $version->read_time ?? 5 }} min read
                                    </span>

                                    <span class="text-sm text-gray-500">
                                        <i class="far fa-thumbs-up mr-1 text-blue-500"></i>
                                        {{ $version->likes ?? 0 }}
                                    </span>
